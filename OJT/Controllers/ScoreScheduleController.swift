...
class ScoreScheduleController : UITableViewController {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if let event = events?[indexPath.section] {
            selectedScheduleId = event.schedules[indexPath.row].scheduleId
            performSegueWithIdentifier("ShowDailyShedule", sender: self)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "ShowDailyShedule" {
            let dailyScheduleController = segue.destinationViewController as! DailyScheduleController
            dailyScheduleController.selectedScheduleId = self.selectedScheduleId
            dailyScheduleController.selectedTarget = self.selectedTarget
